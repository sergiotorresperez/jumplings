...
import net.garrapeta.demo.R.id;
...
public class GameOverActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		TextView scoreTextView   = (TextView) findViewById(id.gameover_scoreTextView);
		scoreTextView.setText("Your score: " + playerScore.score);
		
		HighScore highest = PermData.getInstance().getLocalGetHighScore();
		if (highest != null) {
			TextView messageTextView = (TextView) findViewById(id.gameover_messageTextView);
		...
		scoreIntroductionView = findViewById(id.gameover_nameIntroductionLayout);
		nextActionView       = findViewById(id.gameover_nextActionView);
		
		if (newHighScore) {
			scoreIntroductionView.setVisibility(View.VISIBLE);
			nextActionView.setVisibility(View.INVISIBLE);
			
			playerNameEditText = (EditText) findViewById(id.gameover_playerNameEditText);
		...
		if (waveKey != null) {
			Button replayButton = (Button) findViewById(id.gameover_replayBtn);
		...
		Button menuButton = (Button) findViewById(id.gameover_menuBtn);
		...
		Button viewHighScoresButton = (Button) findViewById(id.gameover_viewHighScoresBtn);
		...
		Button saveScoreButton = (Button) findViewById(id.gameover_saveScoreBtn);
		...
		if (JumplingsApplication.FEINT_ENABLED) { 
			postToFeintButton = (Button) findViewById(id.gameover_postToFeintBtn);
		...
		if (JumplingsApplication.FACEBOOK_ENABLED) {
			postToFacebookButton = (Button) findViewById(id.gameover_postToFacebookBtn);
		...
		if (JumplingsApplication.TWITTER_ENABLED) {
			postToTwitterButton = (Button) findViewById(id.gameover_postToTwitterBtn);
