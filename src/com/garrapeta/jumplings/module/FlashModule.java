...
public class FlashModule  {
    ...
    private final static int SWORD_SWING_DURATION = 250;
    private final static int SWORD_SWING_ALPHA = 50;
    private final static int SWORD_SWING_COLOR = Color.WHITE;
	...
	private final static FlashData SWORD_DRAWN_DATA = new FlashData(FLASH_SWORD_DRAWN_COLOR, FLASH_SWORD_DRAWN_ALPHA, FLASH_SWORD_DRAWN_DURATION, FLASH_SWORD_DRAWN_PRIORITY);
	...
	public FlashModule(short minimumLevel, JumplingsGameWorld jumplingsGameWorld) {
        ...
        mDelegate.create(PermData.CFG_LEVEL_SOME, SWORD_DRAWN_KEY).add(SWORD_DRAWN_DATA);
        mDelegate.create(PermData.CFG_LEVEL_ALL, TAP_KEY).add(TAP_DATA);
        mDelegate.create(PermData.CFG_LEVEL_ALL, SWORD_SWING_KEY).add(SWORD_SWING_DATA);
