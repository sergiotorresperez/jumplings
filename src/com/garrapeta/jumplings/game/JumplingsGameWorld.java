package com.garrapeta.jumplings.game;
...
import com.garrapeta.jumplings.game.actor.ComboTextActor;
import com.garrapeta.jumplings.game.actor.EnemyActor;
import com.garrapeta.jumplings.game.actor.JumplingActor;
import com.garrapeta.jumplings.game.actor.LifePowerUpActor;
import com.garrapeta.jumplings.game.actor.MainActor;
import com.garrapeta.jumplings.game.actor.ScoreTextActor;
import com.garrapeta.jumplings.game.module.FlashModule;
import com.garrapeta.jumplings.game.module.ShakeModule;
import com.garrapeta.jumplings.game.scenario.IScenario;
import com.garrapeta.jumplings.game.weapon.FingerprintWeapon;
import com.garrapeta.jumplings.game.weapon.Weapon;
import com.garrapeta.jumplings.game.weapon.WeaponFactory;
import com.garrapeta.jumplings.game.weapon.SwordWeapon.WeaponSwordListener;
...
public class JumplingsGameWorld extends JumplingsWorld implements OnTouchListener, GameEventsListener, WeaponSwordListener {
    ...
    private static final long[] VIBRATION_ENEMY_KILLED_PATTERN = {
            0,
            90 };
    private static final long[] VIBRATION_FAIL_PATTERN = {
            0,
            100,
            50,
            400 };
    ...
    /** Escenario actual */
    private IScenario mScenario = null;
    ...
    public void onBeforeRunning() {
        ...
        mGameActivity.runOnUiThread(new Runnable() {
            @Override
            public void run() {
                mGameActivity.findViewById(R.id.loading)
    ...
    protected void loadResources() {
        ...
        sm.create(PermData.CFG_LEVEL_ALL, SAMPLE_ENEMY_BOING)
          .add(R.raw.boing1)
          .add(R.raw.boing2)
          .add(R.raw.boing3);
        sm.create(PermData.CFG_LEVEL_ALL, SAMPLE_ENEMY_DROP)
          .add(R.raw.drop);
        sm.create(PermData.CFG_LEVEL_ALL, SAMPLE_ENEMY_KILLED)
          .add(R.raw.crush);
        sm.create(PermData.CFG_LEVEL_ALL, SAMPLE_FAIL)
          .add(R.raw.wrong);
        sm.create(PermData.CFG_LEVEL_ALL, SAMPLE_FINGERPRINT)
          .add(R.raw.whip);
        sm.create(PermData.CFG_LEVEL_ALL, SAMPLE_SWORD_SWING)
          .add(R.raw.sword_swing);
        sm.create(PermData.CFG_LEVEL_ALL, SAMPLE_FUSE)
          .add(R.raw.fuse);
        sm.create(PermData.CFG_LEVEL_ALL, SAMPLE_BOMB_BOOM)
          .add(R.raw.bomb_boom);
        sm.create(PermData.CFG_LEVEL_ALL, SAMPLE_BOMB_LAUNCH)
          .add(R.raw.bomb_launch);
        sm.create(PermData.CFG_LEVEL_ALL, SAMPLE_SWORD_SHEATH)
          .add(R.raw.sword_sheath);
        sm.create(PermData.CFG_LEVEL_ALL, SAMPLE_SWORD_UNSHEATH)
          .add(R.raw.sword_unsheath);
        sm.create(PermData.CFG_LEVEL_ALL, SAMPLE_SWORD_STAB)
          .add(R.raw.stab);
        sm.create(PermData.CFG_LEVEL_ALL, SAMPLE_LIFE_UP)
          .add(R.raw.life_up);
    ...
    public int getThread() {
        ...
        for (int i = 0; i < s; i++) {
            hits += MainActor.getBaseThread(mMainActors.get(i)
                                                       .getCode());
        }
        return hits;
    }
